...
const FounderAuthority = () => {
  return (
    <section className="bg-[#030303] py-32 px-6 md:px-24 text-white text-left border-b border-white/5 relative z-20">
      <div className="flex flex-col md:flex-row items-center gap-20 md:gap-32 mb-28 text-left">
        ...
        >
          <div className="relative aspect-[4/5] bg-[#0a0a0a] overflow-hidden grayscale group border border-white/5 text-left rounded-lg">
            <Image 
                src="/piyush.png" 
                alt="Founder" 
                fill
            ...
            <div className="absolute bottom-8 left-8 z-20 text-left">
              <div className="bg-black/90 px-6 py-3 border border-[#F3D7A7]/30 flex flex-col text-left backdrop-blur-md rounded-sm">
