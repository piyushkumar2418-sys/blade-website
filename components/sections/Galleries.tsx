...
const youtubeWorks: Work[] = [
  { 
    ...
    video: "/preview1.mp4", 
    img: "/thumb1.jpg",
    goal: "Increase organic engagement for India's top podcast",
    outcome: "15M+ Views & 40% retention increase"
  },
  { 
    ...
    video: "/preview2.mp4", 
    img: "/thumb2.jpg",
    goal: "Build brand authority in personal finance niche",
    outcome: "Scaled from 0 to 100k subscribers in 4 months"
  },
  { 
    title: "Right Now With Rohan", 
    category: "Podcast", 
    link: "https://youtu.be/i7uwh0CzfRM", 
    video: "/preview3.mp4", 
    img: "/thumb3.jpg",
    goal: "Establish high-velocity dynamic podcast edits",
    outcome: "Featured on YouTube Trending with 1.2M views"
  },
];
...
const verticalWorks: Work[] = [
  { 
    ...
    video: "/preview5.mp4", 
    img: "/thumb5.webp",
    goal: "Optimize vertical video retention hook",
    outcome: "2.1M views in 7 days"
  },
  { 
    ...
    video: "/preview6.mp4", 
    img: "/thumb6.webp",
    goal: "Deliver premium lifestyle storytelling format",
    outcome: "500k+ organic reach & 20k+ shares"
  },
  { 
    title: "Dynamic Flow", 
    ...
    video: "/preview7.mp4", 
    img: "/thumb7.jpg",
    goal: "Leverage premium dynamic assets",
    outcome: "45% increase in view duration"
  },
  { 
    ...
    video: "/preview8.mp4", 
    img: "/thumb8.jpeg",
    goal: "Maximize retention signals & conversion CTA",
    outcome: "3.2x boost in lead conversions"
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-5 left-5 right-5 z-40 text-left transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
          <span className="text-[#F3D7A7] text-[8px] uppercase tracking-[0.3em] block mb-1 font-bold">{work.category}</span>
          <h4 className="text-sm md:text-base font-bold uppercase tracking-tight text-white mb-2">{work.title}</h4>
          {work.goal && (
            <div className="text-[10px] text-white/50 leading-relaxed uppercase tracking-wider hidden group-hover:block transition-all duration-300 font-sans">
              <span className="text-white/30">Goal:</span> {work.goal} <br />
              <span className="text-white/30">Result:</span> <span className="text-[#F3D7A7] font-bold">{work.outcome}</span>
            </div>
          )}
        </div>
      </motion.a>
