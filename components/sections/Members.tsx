      ...
      <div className="w-full relative z-10 flex flex-col items-center">
        ...
        <div className="mb-16 flex flex-col items-center text-center px-6">
          ...
          <h2 className="text-3xl md:text-5xl tracking-tight text-neutral-950 text-center leading-tight">
            <span className="font-['Helvetica',_sans-serif] font-bold">Our members</span> <span className="font-serif italic font-normal text-[#FFC800] lowercase tracking-normal normal-case">are working with</span>
          </h2>
        </div>
