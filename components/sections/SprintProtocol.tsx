          ...
          <div className="lg:w-1/2 flex flex-col justify-between items-start relative z-10 py-1">
            <div className="space-y-4">
              ...
              <p className="text-white/60 text-xs font-normal leading-relaxed font-sans max-w-md">
                Unleash the secret psychology of viewer engagement. Master high-retention frameworks, hook engineering structures, and positioning strategies that dictate modern social algorithms.
              </p>
            </div>
            ...
            <div className="w-full glassy-panel rounded-xl p-5 mt-8 flex-1 flex flex-col justify-center space-y-2.5 shadow-inner">
              <div className="space-y-2 text-xs md:text-[13px] font-bold text-white/80 font-sans tracking-tight">
                <div className="flex items-center gap-2">
                  ...
                  <span>Hook Engineering & packaging</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Audience Behaviour & psychology</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Retention Strategy & editing</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Content Strategy & positioning</span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full items-stretch">
          ...
          <div className="glassy-card rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between transition-all duration-300">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <p className="text-white/60 text-[11px] font-normal leading-relaxed font-sans">
                Outbound infrastructure setup. Construct high-ticket offers, launch automated cold outbound loops, and close retainers.
              </p>
            </div>
            ...
            <div className="w-full glassy-panel rounded-lg p-4 my-4 flex-1 flex flex-col justify-center space-y-2 shadow-inner">
              <div className="space-y-2 text-[11px] md:text-xs font-bold text-white/80 font-sans tracking-tight">
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Offer Creation & pricing design</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Cold Outreach & lead generation</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Sales Calls & objections</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Client Onboarding & delivery</span>
                </div>
              </div>
            </div>
          ...
          <div className="glassy-card rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between transition-all duration-300">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <p className="text-white/60 text-[11px] font-normal leading-relaxed font-sans">
                Build scale. Design content engines, automated Slack task workflows, Notion documentation, and remote editing teams.
              </p>
            </div>
            ...
            <div className="w-full glassy-panel rounded-lg p-4 my-4 flex-1 flex flex-col justify-center space-y-2 shadow-inner">
              <div className="space-y-2 text-[11px] md:text-xs font-bold text-white/80 font-sans tracking-tight">
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Delivery Systems & task boards</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Workflow Architecture & design</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>SOP Creation & team building</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Automation & approval flows</span>
                </div>
              </div>
            </div>
          ...
          <div className="glassy-card rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between transition-all duration-300">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <p className="text-white/60 text-[11px] font-normal leading-relaxed font-sans">
                Evolve your mindset. Shed perfectionism, construct objective decision frameworks, and conquer launches.
              </p>
            </div>
            ...
            <div className="w-full glassy-panel rounded-lg p-4 my-4 flex-1 flex flex-col justify-center space-y-2 shadow-inner">
              <div className="space-y-2 text-[11px] md:text-xs font-bold text-white/80 font-sans tracking-tight">
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Decision Making & launch day</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>First Money & price psychology</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Imposter & perfectionism cures</span>
                </div>
          ...
          <div className="glassy-card rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between transition-all duration-300">
            ...
            {/* Pulsing "New" Badge in Gold */}
            <span className="bg-[#FFC800] text-black text-[7.5px] font-mono font-bold px-2 py-0.5 rounded-full uppercase tracking-wider absolute top-4 right-4 shadow-[0_0_10px_rgba(255,200,0,0.3)] animate-pulse z-20 select-none">
              ★ New
            </span>
            ...
            <div className="w-full glassy-panel rounded-lg p-4 my-4 flex-1 flex flex-col justify-center space-y-2 shadow-inner">
              <div className="space-y-2 text-[11px] md:text-xs font-bold text-white/80 font-sans tracking-tight">
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Neural Video Generation & Motion</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Multimodal Scripting & Ideation</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>Voice Cloning & Avatars</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#FFC800] font-black select-none">+</span>
                  <span>AI Prompt Engineering & Scale</span>
                </div>
              </div>
            </div>
