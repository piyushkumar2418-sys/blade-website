...
const PricingSection = () => {
  return (
    <section
      className="bg-[#050505] py-24 sm:py-32 px-4 sm:px-8 md:px-16 lg:px-20 text-white relative overflow-hidden border-b border-white/5"
      style={{
        backgroundImage:
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-20">
            <div className="flex items-center gap-1.5 bg-[#FFC800] text-black px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-wider shadow-[0_0_20px_rgba(255,200,0,0.4)]">
          ...
          <div className="relative bg-white/[0.03] backdrop-blur-xl border border-[#FFC800]/20 rounded-3xl p-6 sm:p-10 shadow-[0_30px_80px_rgba(0,0,0,0.5),_inset_0_1px_1px_rgba(255,255,255,0.04)] overflow-hidden">
            ...
            <div className="text-center mb-8 relative z-10">
              ...
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-[#FFC800] text-5xl sm:text-6xl md:text-7xl font-black tracking-tighter leading-none" style={{ textShadow: '0 0 30px rgba(255, 200, 0, 0.3)' }}>
                  ₹6,499
                </span>
              </div>
            ...
            <div className="space-y-3.5 mb-8 relative z-10">
              ...
              {featuresList.map((feature, idx) => (
                ...
                >
                  <div className="w-5 h-5 rounded-full bg-[#FFC800]/10 border border-[#FFC800]/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="w-3 h-3 text-[#FFC800]" />
                  </div>
                  <span className="text-white/70 text-sm leading-relaxed font-sans">
                    {feature}
                  </span>
                </motion.div>
              ))}
            ...
            <p className="text-center text-white/25 text-[10px] mt-4 font-mono">
