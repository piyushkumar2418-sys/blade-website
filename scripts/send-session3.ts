...
// Set this to false to blast to all enrolled students
const TEST_MODE = false;
const TEST_EMAIL = "piyushkumar2418@gmail.com";

const MEETING_DETAILS = {
  date: "Tuesday, 19 May · 8:30 – 9:30pm",
  link: "https://meet.google.com/vwx-ycgb-wdh"
};

async function sendSession3Emails() {
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #f7f3eb; padding: 60px 20px;">
    <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border: 1px solid rgba(0,0,0,0.1); border-radius: 12px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding: 40px; text-align: left;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                Tonight is <strong>Session 03: Editing Framework & Niche Selection</strong>.
              </p>
              
              <p style="margin: 0 0 32px 0; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                In this session, we will break down the exact Hook -> Retention -> Payoff framework used to engineer viral attention. We will also cover content structure fundamentals and help you finalize a profitable niche for your agency. This is where tactical execution begins.
              </p>
          ...
          <tr>
            <td style="padding: 30px 40px; background-color: #faf8f2; text-align: left; border-top: 1px solid rgba(0,0,0,0.05);">
              <p style="margin: 0 0 10px 0; font-size: 12px; color: #777777; line-height: 1.6;">
                Attendance is mandatory. Please join the meeting 5 minutes early with your notepad ready.
              </p>
      ...
      const data = await resend.emails.send({
        ...
        to: [student.email],
        subject: "Blade Inner Circle Cohort 01 — Session 03 Access",
        html: htmlContent,
      });
