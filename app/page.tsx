    ...
    { 
      ...
      svg: (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="324" height="137" viewBox="0 0 324 137" className="h-10 md:h-14 w-auto">
          <path d="M0 0 C4.79 0 8.95 0.54 13.56 1.81 C14.2 1.97 14.85 2.14 15.52 2.31 C21.04 3.8 24.79 5.43 28.31 10 C30.78 14.75 30.83 19.78 30 25 C28.72 27.04 27.4 29.05 26 31 C26.24 36.24 28.39 39.89 31.06 44.25 C35 50.76 35 50.76 35 53 C31.04 53 27.08 53 23 53 C19.7 47.06 16.4 41.12 13 35 C12.34 35 11.68 35 11 35 C10.67 40.61 10.34 46.22 10 52 C7.36 52 4.72 52 2 52 C0 50 0 50 -0.24 47.86 C-0.23 46.97 -0.23 46.09 -0.22 45.18 C-0.22 44.18 -0.22 43.18 -0.22 42.15 C-0.21 41.06 -0.20 39.98 -0.19 38.86 C-0.19 37.76 -0.18 36.65 -0.18 35.51 C-0.17 31.96 -0.15 28.42 -0.12 24.87 C-0.11 22.47 -0.10 20.07 -0.09 17.67 C-0.07 11.78 -0.04 5.89 0 0 Z " fill="currentColor" transform="translate(134,55)"/>
          <path d="M0 0 C1.6 2.53 2.93 4.89 4.25 7.56 C5.48 10.01 6.72 12.47 8 15 C10.31 9.72 12.62 4.44 15 -1 C23.49 -1.09 23.49 -1.09 26 -1 C27.61 0.61 27.12 2.36 27.12 4.59 C27.13 5.57 27.13 6.55 27.13 7.55 C27.13 8.62 27.13 9.68 27.13 10.78 C27.13 11.86 27.13 12.94 27.13 14.06 C27.13 16.36 27.13 18.65 27.13 20.95 C27.12 24.48 27.13 28.01 27.13 31.54 C27.13 33.76 27.13 35.99 27.13 38.21 C27.13 39.28 27.13 40.34 27.13 41.44 C27.13 42.9 27.13 42.9 27.12 44.4 C27.12 45.26 27.12 46.13 27.12 47.02 C27 49 27 49 26 50 C23.96 49.91 23.96 49.91 21.5 49.62 C20.27 49.48 20.27 49.48 19.03 49.35 C17 49 17 49 16 48 C15.91 46.07 15.89 44.14 15.9 42.21 C15.9 41.04 15.9 39.87 15.91 38.66 C15.92 37.43 15.92 36.2 15.93 34.93 C15.94 33.7 15.94 32.46 15.95 31.19 C15.96 28.12 15.97 25.06 16 22 C15.34 22 14.68 22 14 22 C13.77 22.88 13.54 23.77 13.31 24.68 C11.82 28.43 9.97 30.33 7 33 C3.98 28.46 1.46 24.31 0 19 C-0.66 19 -1.32 19 -2 19 C-2 26.59 -2 34.18 -2 42 C-8.69 40.66 -8.69 40.66 -11 38 C-11.35 35 -11.46 32.38 -11.39 29.39 C-11.38 28.55 -11.37 27.71 -11.37 26.85 C-11.35 24.17 -11.3 21.49 -11.25 18.81 C-11.22 16.99 -11.21 15.17 -11.19 13.36 C-11.15 8.9 -11.08 4.45 -11 0 C-3.02 -1.38 -3.02 -1.38 0 0 Z " fill="currentColor" transform="translate(89,53)"/>
          <path d="M0 0 C0 10.56 0 21.12 0 32 C-8 36 -8 36 -11 36 C-11 32.04 -11 28.08 -11 24 C-14.63 24 -18.26 24 -22 24 C-22 28.95 -22 33.9 -22 39 C-28 41 -28 41 -33 41 C-33 28.13 -33 15.26 -33 2 C-29.37 2 -25.74 2 -22 2 C-22 6.29 -22 10.58 -22 15 C-18.7 14.34 -15.4 13.68 -12 13 C-11.95 12.14 -11.9 11.29 -11.85 10.41 C-11.77 9.3 -11.7 8.2 -11.62 7.06 C-11.55 5.96 -11.48 4.85 -11.41 3.72 C-11.27 2.82 -11.14 1.92 -11 1 C-9 0 -9 0 0 0 Z " fill="currentColor" transform="translate(228,63)"/>
          <path d="M0 0 C-1.93 12.14 -11.75 21.11 -21.03 28.37 C-42.93 44 -42.93 44 -49 44 C-49 35.42 -49 26.84 -49 18 C-46.56 17.56 -44.13 17.13 -41.62 16.68 C-31.97 14.87 -23.51 12.41 -14.68 8.06 C-14 7.72 -13.32 7.39 -12.61 7.04 C-8.75 5.07 -4.02 0 0 0 Z " fill="currentColor" transform="translate(294,44)"/>
          <path d="M0 0 C1 1 1 1 1.37 3.81 C1 7 1 7 -1.43 9.25 C-2.28 9.82 -3.12 10.4 -4 11 C-5.45 13.91 -5.2 16.5 -5.25 19.75 C-5.27 20.96 -5.3 22.17 -5.32 23.42 C-4.97 27.3 -3.9 29.63 -2 33 C-1.67 33.99 -1.34 34.98 -1 36 C2.25 38.02 5.99 39.2 9.56 40.56 C10.69 40.99 11.83 41.43 13 41.87 C16.6 43.22 19.53 44.17 23.37 44.25 C24.12 44.27 24.87 44.3 25.64 44.32 C28.68 43.9 30.45 42.68 33 41 C34.72 39.93 36.45 38.87 38.18 37.81 C39.04 37.28 39.9 36.75 40.79 36.2 C43 35 43 35 45 35 C45 46.22 45 57.44 45 69 C38.56 66.42 35.08 63.4 30.93 57.93 C25.61 50.92 20.8 48.63 12.18 47.18 C3.33 45.43 -2.17 41.53 -7.58 34.37 C-12.58 25.94 -11.99 16.05 -9.68 6.81 C-8.14 1.23 -5.83 -0.46 0 0 Z " fill="currentColor" transform="translate(29,20)"/>
          <path d="M10.11 34.27 C10.03 40.18 10.02 46.09 10 52 C3.37 52.12 3.37 52.12 0 51 C0 34.17 0 17.34 0 0 C9 1 9 1 10 2 C10.09 3.56 10.11 5.13 10.11 6.7 C10.11 7.7 10.11 8.7 10.11 9.73 C10.10 10.82 10.10 11.91 10.09 13.03 C10.09 14.14 10.09 15.25 10.09 16.39 C10.08 19.95 10.07 23.5 10.06 27.06 C10.05 29.46 10.05 31.87 10.04 34.27 Z " fill="currentColor" transform="translate(120,53)"/>
        </svg>
      )
    },
    { 
