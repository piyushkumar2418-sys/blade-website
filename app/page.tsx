  ...
  return (
    ...
    >
      ...
      <nav className="fixed top-0 w-full z-[60] flex justify-between items-center px-12 py-10 mix-blend-difference">
        <div className="w-32">
          <Image src="/blade-logo.png" alt="Blade Logo" width={120} height={40} style={{ height: 'auto' }} unoptimized loading="eager" />
        </div>
      ...
      {/* SECTION 2: THE MONOLITH (FOUNDER) */}
          ...
          <div className="space-y-64 pt-12">
            <motion.div style={{ opacity: useTransform(scrollYProgress, [0.15, 0.25], [0, 1]) }} className="max-w-md">
              <div className="aspect-[3/4] bg-white/5 w-full mb-16 overflow-hidden border border-white/10 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-700">
                 <div className="text-[10px] uppercase tracking-[0.5em] text-white/20">Founder Photo</div>
              </div>
              <p className="text-white/60 text-xl md:text-2xl leading-relaxed mb-8" style={{ fontFamily: 'Helvetica-Light' }}>
                We didn't learn content from a syllabus; we decoded it through an early obsession. It began at thirteen, experimentation replacing mentorship.
              </p>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24">
            <motion.div whileHover={{ y: -10 }} className="md:col-span-7 group cursor-pointer">
              <div className="aspect-[16/10] bg-white/5 overflow-hidden mb-6 relative border border-white/5"><div className="w-full h-full bg-[#111] group-hover:scale-105 transition-transform duration-700" /></div>
      ...
      <section className="h-screen flex flex-col justify-center items-center text-center relative z-10 px-6">
        <motion.div style={{ opacity: useTransform(scrollYProgress, [0.75, 0.82, 0.88, 0.92], [0, 1, 1, 0]) }} className="flex flex-col items-center">
          <div className="w-72 md:w-[500px]">
            <Image src="/inner-circle-logo.png" alt="Inner Circle Logo" width={500} height={150} style={{ height: 'auto' }} unoptimized className="object-contain" />
          </div>
          <p className="max-w-xl mx-auto text-[#F3D7A7]/60 text-lg md:text-xl mb-12 mt-[-30px]" style={{ fontFamily: 'Kanila' }}>The evolution of the creative mind. A high-level execution program.</p>
        </motion.div>
      </section>

      {/* SECTION 5: CALL BOOKING SYSTEM (THE FINALE) */}
      <section className="min-h-screen flex flex-col justify-center items-center px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            {/* BOOKING BUTTON */}
            <motion.a 
              href="https://calendly.com/YOUR_LINK" // Replace with your actual link
              target="_blank"
              whileHover={{ scale: 1.05, backgroundColor: "#F3D7A7", color: "#000" }}
              className="px-12 py-6 border border-[#F3D7A7] text-[#F3D7A7] rounded-full flex items-center gap-4 transition-colors group"
            >
              <Calendar size={20} />
            ...
            <p className="text-white/30 text-[10px] uppercase tracking-widest max-w-[200px]">
              Limited availability. We prioritize high-alignment partners.
            </p>
          </div>
        </motion.div>
