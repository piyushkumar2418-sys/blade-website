...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* THESE MUST BE OUTSIDE ANIMATEPRESENCE TO ENSURE THEY RE-MOUNT ON MODE SWITCH */}
      {isAgency && (
        <>
      ...
      <AnimatePresence mode="wait">
        {isAgency ? (
          ...
          <motion.div key="innerCircle" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-black bg-white min-h-screen">
            {/* (Hero) */}
            <header className="h-screen flex flex-col justify-center px-6 md:px-24 border-b border-black/5">
              <span className="text-xs uppercase tracking-[0.5em] font-bold mb-8 block text-black/40">Blade Inner Circle</span>
              <h1 className="text-[12vw] md:text-[8vw] font-bold leading-[0.85] tracking-tighter uppercase mb-12">The School of <br/> Modern Content.</h1>
            ...
            <section className="py-32 px-6 md:px-24 bg-white text-left">
              <div className="max-w-4xl">
                ...
                <p className="text-xl md:text-2xl text-black/60 leading-relaxed font-light mb-8">
                  I started at 13. I learned content and agency building by failing until I didn't. Blade Media is the result of that experimentation. The Inner Circle exists to build the room I didn't have.
                </p>
              </div>
            </section>
            ...
            <section className="py-40 px-6 md:px-24 text-center border-t border-black/5">
              <div className="max-w-3xl mx-auto">
                ...
                <button className="bg-black text-white px-20 py-8 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-[#F3D7A7] hover:text-black transition-all">Request Admission Portfolio</button>
              </div>
            </section>
          </motion.div>
        )}
