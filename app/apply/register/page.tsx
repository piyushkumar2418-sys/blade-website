...
export default function CohortRegisterPage() {
  ...
  return (
    <main className="relative min-h-screen bg-white text-black selection:bg-[#F3D7A7] selection:text-black overflow-x-hidden font-sans">
        ...
        >
          <div className="max-w-xl mx-auto text-left">
            ...
            <header className="mb-16 text-left">
              <h2 className="text-4xl font-extrabold uppercase tracking-tighter mb-2 text-left leading-none">
      ...
      {/* Footer */}
      <footer className="w-full h-20 border-t border-black/5 flex items-center justify-center font-mono text-[9px] text-black/20 uppercase tracking-[0.6em] bg-white">
