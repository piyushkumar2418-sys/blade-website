...
export async function sendWaitlistEmail(to: string, name: string, waitlistKey: string) {
  return sendEmail({
    ...
    text: `Hi ${name}, we have logged your request for early access to Cohort 02 (October 2026). Your access key is: ${waitlistKey}.`,
  });
}
...
export async function sendAdmissionConfirmedEmail(to: string, name: string) {
  const BATCH_COHORT_NAME = "Cohort 02 (October 2026)";
            ...
            <td style="padding: 40px; text-align: left;">
              ...
              <div style="background-color: #faf8f2; border: 1px solid rgba(217,180,101,0.3); border-radius: 8px; padding: 24px; margin: 32px 0;">
                ...
                <p style="margin: 0 0 12px 0; font-size: 14px; line-height: 1.5; color: #4a4a4a;">
                  <strong style="color: #000000;">Orientation Date:</strong> October 27th, 2026<br/>
